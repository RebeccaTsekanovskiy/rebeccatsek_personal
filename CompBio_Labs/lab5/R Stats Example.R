...
pengs_clean <- read.csv("finches_data_for_lab.csv")
...
# bar plot with sd bars similar to lab 2
library(ggplot2)
head(weight_sum)
...
# if this probability is low then we say they are statistically significant and different
# low is anything <= 0.05
#             p-value < 2.2e-16
# interpretation: male penguins are significanlty heavier than female penguins
...
# you should modify the finch graphs more than this 
...
summary(reg)
# p-value: 7.337e-16 
# interpretation bill length and bill depth are significantly positively related
